  ...
  <!-- Setting up language for the site an be changed through WP setting -->
  <html <?php language_attributes(); ?>>
    <head>

      <!-- Gives the CHARSET using like UTF-8 -->

        <meta charset="<?php bloginfo(); ?>">

      <!-- Gives the Website mobile friendly view -->
    ...
    <!-- Gives body tag a class used in CSS   -->
    <body <?php body_class(); ?>>
