...
<!-- Wordpress by default search for singe-event.php for custom event type -->
 <?php
 			get_header();
    ...
    <?php
            ...
            $relatedProfessor = new WP_Query(array(
             ...
             <?php }
              ...
              //We are relaying on funtion get_the_ID(); and it returns diffrent for same page with diffrent custom queries. This function reset global POST data back to feault url based query.
